    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="images/admin/logo/logo.png" alt="" /></a>
                <strong><img src="images/admin/logo/logosn.png" alt="" /></strong>
            </div>
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a href="#"><img src="images/admin/notification/4.jpg" alt="" /></a>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard" href="dashboard"><span class="mini-sub-pro">Dashboard</span></a></li>
  
                                <li><a title="Product List" href="product-list"><span class="mini-sub-pro">Product List</span></a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="User List" href="{{route('category-list')}}"><span class="mini-sub-pro">Category List</span></a></li>
