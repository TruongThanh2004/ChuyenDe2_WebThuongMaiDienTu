    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="{{route('dashboard')}}"><img class="main-logo" src="images/admin/logo/logo.png" alt="" /></a>
                <strong><img src="images/admin/logo/logosn.png" alt="" /></strong>
            </div>
            <div class="nalika-profile">
                <div class="profile-dtl">
                    @if (Auth::check())
                        <a href="#"><img src="{{asset('images/user/' . Auth::user()->image)}}" alt="" /></a>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard" href="dashboard"><span
                                            class="mini-sub-pro">Dashboard</span></a></li>

                                <li><a title="Product List" href="product-list"><span class="mini-sub-pro">Product
                                            List</span></a></li>
                        ...
                        <li>
                            <a class="has-arrow" href="" aria-expanded="false"><i
                                    class="icon nalika-user icon-wrap"></i> <span class="mini-click-non">User</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="User List" href="{{route('user-list')}}"><span class="mini-sub-pro">User
                                            List</span></a></li>
